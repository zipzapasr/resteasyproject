            ...
            function () {
                ...
                if (!jQuery('#ptTimeSelectCntr').length) {
                    jQuery("body").append(
                        ...
                        +    '                <a href="#" role="button" onclick="jQuery.ptTimeSelect.closeCntr();" '
                        ...
                        +    '                                <a class="ptTimeSelectHr ui-state-default" href="#" role="button" '
                        ...
                        +    '                                <a class="ptTimeSelectHr ui-state-default" href="#" role="button">1</a>'
                        +    '                                <a class="ptTimeSelectHr ui-state-default" href="#" role="button">2</a>'
                        +    '                                <a class="ptTimeSelectHr ui-state-default" href="#" role="button">3</a>'
                        +    '                                <a class="ptTimeSelectHr ui-state-default" href="#" role="button">4</a>'
                        +    '                                <a class="ptTimeSelectHr ui-state-default" href="#" role="button">5</a>'
                        +    '                                <a class="ptTimeSelectHr ui-state-default" href="#" role="button">6</a>'
                        +    '                                <a class="ptTimeSelectHr ui-state-default" href="#" role="button">7</a>'
                        +    '                                <a class="ptTimeSelectHr ui-state-default" href="#" role="button">8</a>'
                        +    '                                <a class="ptTimeSelectHr ui-state-default" href="#" role="button">9</a>'
                        +    '                                <a class="ptTimeSelectHr ui-state-default" href="#" role="button">10</a>'
                        +    '                                <a class="ptTimeSelectHr ui-state-default" href="#" role="button">11</a>'
                        +    '                                <a class="ptTimeSelectHr ui-state-default" href="#" role="button">12</a>'
                        +    '                                <br style="clear: left;" /><div></div>'
                        +    '                            </div>'
                        +    '                        </div>'
                        +    '                    </div>'
                        ...
                        +    '                                <a class="ptTimeSelectMin ui-state-default" href="#" role="button">00</a>'
                        +    '                                <a class="ptTimeSelectMin ui-state-default" href="#" role="button">05</a>'
                        +    '                                <a class="ptTimeSelectMin ui-state-default" href="#" role="button">10</a>'
                        +    '                                <a class="ptTimeSelectMin ui-state-default" href="#" role="button">15</a>'
                        +    '                                <a class="ptTimeSelectMin ui-state-default" href="#" role="button">20</a>'
                        +    '                                <a class="ptTimeSelectMin ui-state-default" href="#" role="button">25</a>'
                        +    '                                <a class="ptTimeSelectMin ui-state-default" href="#" role="button">30</a>'
                        +    '                                <a class="ptTimeSelectMin ui-state-default" href="#" role="button">35</a>'
                        +    '                                <a class="ptTimeSelectMin ui-state-default" href="#" role="button">40</a>'
                        +    '                                <a class="ptTimeSelectMin ui-state-default" href="#" role="button">45</a>'
                        +    '                                <a class="ptTimeSelectMin ui-state-default" href="#" role="button">50</a>'
                        +    '                                <a class="ptTimeSelectMin ui-state-default" href="#" role="button">55</a>'
                        +    '                                <br style="clear: left;" /><div></div>'
                        +    '                            </div>'
                        +    '                        </div>'
                        +    '                    </div>'
                        ...
                        +    '            <a href="#" role="button" onclick="jQuery.ptTimeSelect.setTime()"'
                        +    '                    onmouseover="jQuery(this).removeClass(\'ui-state-default\').addClass(\'ui-state-hover\');" '
                        +    '                        onmouseout="jQuery(this).removeClass(\'ui-state-hover\').addClass(\'ui-state-default\');"'
                        +    '                        class="ui-corner-all ui-state-default">'
                        +    '                SET'
