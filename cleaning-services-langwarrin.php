    ...
    <section class="features-two service-features-section" style="background-color:#f1f3f2">
      <div class="container">
        <div class="sec-title text-center">
          ...
          <h2>Our Cleaning Services Process in Langwarrin
          </h2>
        </div>
        <div class="row">
          <div class="col-xl-12">
            <div class="features-two__inner">
              ...
              <ul class="features-two__list">
                <li class="wow fadeInLeft animated animated" data-wow-delay="100ms" data-wow-duration="1000ms"
                  ...
                  <div class="inner">
                    <h2 style="font-size: 21px;">Initial Cleaning Needs Analysis
                    </h2>
                    <p>Cleaning needs are analyzed for the property.
                    </p>
                  </div>
                </li>
                ...
                <li class="style2 style3 wow fadeInRight animated animated" data-wow-delay="0ms"
                  ...
                  <div class="inner">
                    <h2><span class="box-blue">Planning of the Cleaning Service</span></h2>
                    <p>Appropriate cleaning service plan is devised as per cleaning needs.
                    </p>
                  </div>
                </li>
              </ul>
              ...
              <ul class="features-two__list">
                <li class="style3 wow fadeInLeft animated animated" data-wow-delay="100ms" data-wow-duration="1000ms"
                  ...
                  <div class="inner">
                    <h2><span class="box-blue"> Professional Cleaning</span></h2>
                    <p>Cleaning work is done with appropriate methods and tools.</p>
                  </div>
                </li>
                ...
                <li class="style2  wow fadeInRight animated animated" data-wow-delay="0ms" data-wow-duration="1000ms"
                  ...
                  <div class="inner">
                    ...
                    <p>Quality check of the cleaned property is done.
