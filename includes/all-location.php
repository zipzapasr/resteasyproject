        ...
        <div class="row align-items-start g-4 g-xl-5">
            <div class="col-xl-6 col-lg-6">
                <div class="aws-areas__intro">
                    ...
                    <h2 class="aws-areas__title">Areas We Serve</h2>
                    <p class="aws-areas__text">
                        We cover the Mornington Peninsula, Frankston, Brighton, and Melbourne’s southeast,
                        including major suburbs and surrounding areas.
                    </p>
                </div>

                <div class="aws-areas__group">
                    <h3 class="aws-areas__group-title">Mornington Peninsula :</h3>
                ...
                <div class="aws-areas__group">
                    <h3 class="aws-areas__group-title">Bayside &amp; Frankston :</h3>
                    <div class="aws-areas__tags">
                ...
                <div class="aws-areas__group">
                    <h3 class="aws-areas__group-title">Eastern &amp; South-East :</h3>
                    <div class="aws-areas__tags">
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="aws-areas__map-card">
                    ...
                    <div class="aws-areas__map">
                        <iframe src="googlemap.php" title="Service areas map" loading="lazy"
