                    ...
                    <div class="footer-widget__single footer-widget__single-newsletter footer-accordion">
                        ...
                        <div class="footer-accordion__content">
                            <ul class="footer-widget__single-links-list">
                                ...
                                <li><a href="house-maintenance-services.php">House maintenance</a></li>
                                <li><a href="garden-maintenance-services.php">Gardening</a></li>
                                <li><a href="ndis-cleaning-service.php">NDIS Cleaning</a></li>
                                <li><a href="locksmith-services.php">Locksmith</a></li>
                                <li><a href="#">Carpet cleaning</a></li>
                                <li><a href="#">Pressure Washing</a></li>
                                <li><a href="#">Car Park Cleaning</a></li>
                    ...
                    <div class="footer-widget__single footer-widget__single-newsletter footer-accordion">
                        ...
                        <div class="footer-accordion__content">
                            <ul class="footer-widget__single-links-list">
                                ...
                                <li><a href="#">Dromana</a></li>
                                <li><a href="#">Mount Eliza</a></li>
                                <li><a href="#">Mornington</a></li>
                                <li><a href="#">Mount Martha</a></li>
                                <li><a href="#">Safety Beach</a></li>
                                <li><a href="#">Somerville</a></li>
                                <li><a href="#">Carrum Downs</a></li>
                                <li><a href="#">Langwarrin</a></li>
                       ...
                       <div class="title footer-accordion__header">
                        ...
                        <div class="footer-accordion__content">
                            <ul class="footer-widget__single-links-list">
                                ...
                                <li><a href="#">Glen waverley</a></li>
                                <li><a href="#">Wheelers Hill</a></li>
                                <li><a href="#">MT Waverley</a></li>
                                <li><a href="#">Toorak</a></li>
                                <li><a href="#">Doncaster</a></li>
                                <li><a href="#">Donvale</a></li>
                                <li><a href="#">Boxhill</a></li>
                                <li><a href="#">Burwood</a></li>
                                <li><a href="#">Vermont</a></li>
                                <li><a href="#">Camberwell</a></li>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="myform bg-dark">
                        ...
                        <?php
                        // Google Forms integration (same as contact.php)
                        $googleForm = array(
                        ...
                        <form id="contact-form"
                            ...
                            data-google-form="1" autocomplete="on">
                            <div class="row">
